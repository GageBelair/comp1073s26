...
let myArray = ["string", true, 100, [5, true]];
...
let orig6 = "Toronto Maple Leafs, Chicago Blackhawks, Montréal Canadiens, Detroit Red Wings, Boston Bruins, New York Rangers";
...
output.textContent = `The last element of the array is ${orig6Array.at (-1)} `;
...
orig6Array.splice(3, 1, "Edmonton Oilers", "Calgary Flames");
